...
decodeOpcodeW8 w = Opcode istr args cycles len (Left w)
    ...
    (istr, args, cycles, len) = case w of
        ...
        0x12 -> (LD, BinOp (Reg16 DE) (Reg8 A), [8], 1)
        ...
        0x2a -> (LDI, BinOp (Reg8 A) (Reg16 HL), [8], 1)
        ...
        0x32 -> (LDD, BinOp (Reg16 HL) (Reg8 A), [8], 1)
        0x33 -> (INC, UnOp (Reg16 SP), [8], 1)
        0x34 -> (INC, UnOp (Reg16 HL), [12], 1)
        0x35 -> (DEC, UnOp (Reg16 HL), [12], 1)
        0x36 -> (LD, BinOp (Reg16 HL) D8, [12], 2)
        0x37 -> (SCF, Unit, [4], 1)
        0x38 -> (JR, BinOp (Reg8 C) R8, [12 , 8], 2)
        0x39 -> (ADD, BinOp (Reg16 HL) (Reg16 SP), [8], 1)
        0x3a -> (LDD, BinOp (Reg8 A) (Reg16 HL), [8], 1)
        ...
        0x46 -> (LD, BinOp (Reg8 B) (Reg16 HL), [8], 1)
        ...
        0x4e -> (LD, BinOp (Reg8 C) (Reg16 HL), [8], 1)
        ...
        0x56 -> (LD, BinOp (Reg8 D) (Reg16 HL), [8], 1)
        ...
        0x5e -> (LD, BinOp (Reg8 E) (Reg16 HL), [8], 1)
        ...
        0x66 -> (LD, BinOp (Reg8 H) (Reg16 HL), [8], 1)
        ...
        0x6e -> (LD, BinOp (Reg8 L) (Reg16 HL), [8], 1)
        0x6f -> (LD, BinOp (Reg8 L) (Reg8 A), [4], 1)
        0x07 -> (RLCA, Unit, [4], 1)
        0x70 -> (LD, BinOp (Reg16 HL) (Reg8 B), [8], 1)
        0x71 -> (LD, BinOp (Reg16 HL) (Reg8 C), [8], 1)
        0x72 -> (LD, BinOp (Reg16 HL) (Reg8 D), [8], 1)
        0x73 -> (LD, BinOp (Reg16 HL) (Reg8 E), [8], 1)
        0x74 -> (LD, BinOp (Reg16 HL) (Reg8 H), [8], 1)
        0x75 -> (LD, BinOp (Reg16 HL) (Reg8 L), [8], 1)
        0x76 -> (HALT, Unit, [4], 1)
        0x77 -> (LD, BinOp (Reg16 HL) (Reg8 A), [8], 1)
        ...
        0x7e -> (LD, BinOp (Reg8 A) (Reg16 HL), [8], 1)
        ...
        0x86 -> (ADD, BinOp (Reg8 A) (Reg16 HL), [8], 1)
        ...
        0x8e -> (ADC, BinOp (Reg8 A) (Reg16 HL), [8], 1)
        ...
        0x9e -> (SBC, BinOp (Reg8 A) (Reg16 HL), [8], 1)
        0x9f -> (SBC, BinOp (Reg8 A) (Reg8 A), [4], 1)
        0x0a -> (LD, BinOp (Reg8 A) (Reg16 BC), [8], 1)
...
decodeOpcodeW16 w = Opcode istr args cycles len (Right w)
    ...
    (istr, args, cycles, len) = case w of
        ...
        0xcb36 -> (SWAP, UnOp (Reg16 HL), [16], 2)
        ...
        0xcb46 -> (BIT, BinOp (Bit 0) (Reg16 HL), [16], 2)
        ...
        0xcb4e -> (BIT, BinOp (Bit 1) (Reg16 HL), [16], 2)
        ...
        0xcb56 -> (BIT, BinOp (Bit 2) (Reg16 HL), [16], 2)
        ...
        0xcb5e -> (BIT, BinOp (Bit 3) (Reg16 HL), [16], 2)
        0xcb5f -> (BIT, BinOp (Bit 3) (Reg8 A), [8], 2)
        0xcb06 -> (RLC, UnOp (Reg16 HL), [16], 2)
        ...
        0xcb66 -> (BIT, BinOp (Bit 4) (Reg16 HL), [16], 2)
        ...
        0xcb6e -> (BIT, BinOp (Bit 5) (Reg16 HL), [16], 2)
        ...
        0xcb76 -> (BIT, BinOp (Bit 6) (Reg16 HL), [16], 2)
        ...
        0xcb7e -> (BIT, BinOp (Bit 7) (Reg16 HL), [16], 2)
        ...
        0xcb86 -> (RES, BinOp (Bit 0) (Reg16 HL), [16], 2)
        ...
        0xcb8e -> (RES, BinOp (Bit 1) (Reg16 HL), [16], 2)
        ...
        0xcb96 -> (RES, BinOp (Bit 2) (Reg16 HL), [16], 2)
        ...
        0xcb9e -> (RES, BinOp (Bit 3) (Reg16 HL), [16], 2)
        ...
        0xcba6 -> (RES, BinOp (Bit 4) (Reg16 HL), [16], 2)
        ...
        0xcbae -> (RES, BinOp (Bit 5) (Reg16 HL), [16], 2)
        ...
        0xcbb6 -> (RES, BinOp (Bit 6) (Reg16 HL), [16], 2)
        ...
        0xcbbe -> (RES, BinOp (Bit 7) (Reg16 HL), [16], 2)
        ...
        0xcbc6 -> (SET, BinOp (Bit 0) (Reg16 HL), [16], 2)
        ...
        0xcbce -> (SET, BinOp (Bit 1) (Reg16 HL), [16], 2)
        ...
        0xcbd6 -> (SET, BinOp (Bit 2) (Reg16 HL), [16], 2)
        ...
        0xcbde -> (SET, BinOp (Bit 3) (Reg16 HL), [16], 2)
        0xcbdf -> (SET, BinOp (Bit 3) (Reg8 A), [8], 2)
        0xcb0e -> (RRC, UnOp (Reg16 HL), [16], 2)
        ...
        0xcbe6 -> (SET, BinOp (Bit 4) (Reg16 HL), [16], 2)
        ...
        0xcbee -> (SET, BinOp (Bit 5) (Reg16 HL), [16], 2)
        ...
        0xcbf6 -> (SET, BinOp (Bit 6) (Reg16 HL), [16], 2)
        ...
        0xcbfe -> (SET, BinOp (Bit 7) (Reg16 HL), [16], 2)
